...
A premium, interactive developer portal distributing high-utility utility plugins for [Blockbench](https://www.blockbench.net/): **ModelEngine Format** (`meg.js`) and **Iterative Texture Editing Macros** (`item.js`).
...
### 2. Iterative Texture Editing Macros (`item.js`)
